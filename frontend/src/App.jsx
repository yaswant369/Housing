 ...
 function AppModals() {
  const {
    isPostModalOpen, handleClosePostModal, handleAddProperty, handleEditProperty, propertyToEdit,
     isAuthModalOpen, handleCloseAuthModal, handleLoginSuccess,
     filters, handleCloseFilterModal, handleApplyFilters,
     isEditProfileModalOpen, handleCloseEditProfileModal, currentUser, handleProfileUpdate
 ...
 // It ASSUMES your main.jsx is providing the <BrowserRouter>
 export default function AppWrapper() {
   return (
     // <BrowserRouter> <-- REMOVED! This was the error.
       <AppProvider>
         <Toaster 
