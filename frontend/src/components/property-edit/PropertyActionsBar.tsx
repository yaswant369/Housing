        ...
        <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center">
              ...
              <p className="text-xs text-gray-600 dark:text-gray-400">Views (7 days)</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-gray-600 dark:text-gray-400">Leads (7 days)</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-gray-600 dark:text-gray-400">Shortlists</p>
            </div>
          </div>
        </div>
      )}
