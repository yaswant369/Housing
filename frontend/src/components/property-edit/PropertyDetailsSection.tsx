  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg border border-blue-200 dark:border-blue-700">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-20 py-3 border border-blue-300 dark:border-blue-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800"
              />
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-20 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800"
              />
              <span className="absolute right-3 top-1/2 transform -translate-y-1/2 text-sm text-gray-500">
                sq.ft
              </span>
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center p-3 bg-white dark:bg-gray-800 rounded-lg border">
            <p className="text-sm text-gray-600 dark:text-gray-400">Carpet/Built-up Ratio</p>
            <p className="font-semibold text-gray-900 dark:text-gray-100">
              {builtUp > 0 && carpet > 0 ? `${Math.round((carpet / builtUp) * 100)}%` : 'N/A'}
            </p>
          </div>
          <div className="text-center p-3 bg-white dark:bg-gray-800 rounded-lg border">
            <p className="text-sm text-gray-600 dark:text-gray-400">Super/Built-up Ratio</p>
            <p className="font-semibold text-gray-900 dark:text-gray-100">
      ...
      <div>
        ...
        <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-400">Total Car Parking</p>
              <p className="font-semibold text-gray-900 dark:text-gray-100">
                {((formData.coveredParking || 0) + (formData.openParking || 0))} spots
              </p>
            </div>
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-400">Total Bike Parking</p>
              <p className="font-semibold text-gray-900 dark:text-gray-100">
                {((formData.coveredBikeParking || 0) + (formData.openBikeParking || 0))} spots
              </p>
            </div>
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-400">Covered Parking</p>
              <p className="font-semibold text-gray-900 dark:text-gray-100">
                {((formData.coveredParking || 0) + (formData.coveredBikeParking || 0))} spots
              </p>
            </div>
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-400">Open Parking</p>
              <p className="font-semibold text-gray-900 dark:text-gray-100">
        ...
        <div>
          ...
          <div className="space-y-3">
            {furnishingOptions.map((option) => (
              <label
                key={option.value}
                className="flex items-center gap-3 p-4 border border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer hover:border-blue-500 transition-colors"
              >
                <input
                  type="radio"
                  name="furnishing"
          ...
          <div className="grid grid-cols-2 gap-3">
            {flooringTypes.map((type) => {
              ...
              return (
                <label
                  key={type.value}
                  className="flex items-center gap-3 p-3 border border-gray-300 dark:border-gray-600 rounded-lg cursor-pointer hover:border-blue-500 transition-colors"
                >
                  <input
                    type="radio"
                    name="flooring"
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-blue-600 dark:text-blue-400 font-medium">Area</p>
        ...
        <div className="bg-orange-50 dark:bg-orange-900/20 p-4 rounded-lg border border-orange-200 dark:border-orange-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-orange-600 dark:text-orange-400 font-medium">Parking</p>
        ...
        <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg border border-purple-200 dark:border-purple-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-purple-600 dark:text-purple-400 font-medium">Furnishing</p>
      ...
      <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg border">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Additional Features</h3>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Security Features */}
          <div>
            <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-3">Security & Safety</h4>
            <div className="space-y-2">
              {[
