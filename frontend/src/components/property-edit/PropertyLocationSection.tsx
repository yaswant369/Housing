        ...
        <div className="flex gap-3">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 border border-blue-300 dark:border-blue-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800"
      ...
      <div>
        ...
        <div className="mb-4">
          <label className="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
            <input
              type="checkbox"
              checked={formData.hideExactLocation || false}
        ...
        {showMap && (
          <div className="border border-gray-300 dark:border-gray-600 rounded-lg overflow-hidden">
            <div 
              ref={mapRef}
              className="h-64 bg-gray-100 dark:bg-gray-800 flex items-center justify-center relative"
            >
              {/* Mock Map Interface */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-blue-600 dark:text-blue-400 font-medium">Full Address</p>
        ...
        <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg border border-green-200 dark:border-green-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-green-600 dark:text-green-400 font-medium">Coordinates</p>
        ...
        <div className="bg-orange-50 dark:bg-orange-900/20 p-4 rounded-lg border border-orange-200 dark:border-orange-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-orange-600 dark:text-orange-400 font-medium">Location Privacy</p>
