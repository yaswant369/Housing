    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <button
            ...
            className="flex items-center gap-3 p-4 border border-gray-300  rounded-lg hover:border-blue-500 hover:bg-blue-50  transition-colors"
          >
            <Eye size={20} className="text-blue-600" />
            <div className="text-left">
              <p className="font-medium text-gray-900  Listing</p>
              <p className="text-sm text-gray-600  public listing</p>
            </div>
          </button>

          <button
            onClick={onArchiveProperty}
            className="flex items-center gap-3 p-4 border border-gray-300  rounded-lg hover:border-yellow-500 hover:bg-yellow-50  transition-colors"
          >
            <Archive size={20} className="text-yellow-600" />
            <div className="text-left">
              <p className="font-medium text-gray-900 
              <p className="text-sm text-gray-600  from listing</p>
            </div>
          </button>

          <button
            onClick={onDeleteProperty}
            className="flex items-center gap-3 p-4 border border-gray-300  rounded-lg hover:border-red-500 hover:bg-red-50  transition-colors"
          >
            <Trash2 size={20} className="text-red-600" />
            <div className="text-left">
              <p className="font-medium text-gray-900 
              <p className="text-sm text-gray-600  removal</p>
            </div>
          </button>
        </div>
      </div>
      ...
      <div className="bg-gray-50  p-6 rounded-lg border">
        ...
        <div className="space-y-3">
          ...
          {property.statusHistory && property.statusHistory.map((entry, index) => (
