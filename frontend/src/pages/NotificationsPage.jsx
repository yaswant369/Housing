        ...
        <div className="p-4 border-b border-gray-200 bg-white">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              {/* Category Filter */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="notification-category">
                  Category
                </label>
                <select
              ...
              {/* Status Filter */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="notification-status">
                  Status
                </label>
                <select
        ...
        {loading ? (
          ...
          <div className="p-4">
            ...
            <div className="flex items-center justify-between mb-4">
              <label className="flex items-center space-x-2" htmlFor="select-all-notifications">
                <input
                  type="checkbox"
            ...
            <div className="space-y-3">
              {filteredNotifications.map((notification) => (
                <div key={notification.id} className="relative">
                  <label className="absolute top-4 left-4 z-10" htmlFor={`notification-select-${notification.id}`}>
                    <input
                      type="checkbox"
